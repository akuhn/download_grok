...
A few practical notes. This depends on private twitter internals, so expect breakage when they move things around. Keep cookie files local, never commit them and treat this as a practical personal utility: not by-the-book, but it works.
